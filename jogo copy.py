...
som_colisao = pygame.mixer.Sound('smb_bump.wav')
som_colisao.set_volume(0.4)

som_gameOver = pygame.mixer.Sound('smb_breakblock.wav')
som_gameOver.set_volume(0.4)

som_startGame = pygame.mixer.Sound('smw2_key_get.wav')
...
img2 = pygame.image.load('sad_snake2.png')
